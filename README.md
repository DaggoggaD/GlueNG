...
*Note: better real human written documentation is available in docs/, or using the doxygen docs at [text](https://daggoggad.github.io/GlueNG/). This readme file is just a temporary "presentation" of the project.*
